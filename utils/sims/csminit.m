function [fhat,xhat,fcount,retcode] = csminit(fcn,x0,f0,g0,badg,H0,nodisp,varargin)
...
%      toc
   ...
   if ~badg
      ...
      if a<ANGLE
         ...
         if ~nodisp
            fprintf('Correct for low angle: %g\n',a)
         end
      end
   end
   if ~nodisp
      fprintf('Predicted improvement: %18.9f\n',-dfhat/2)
   end
   %
